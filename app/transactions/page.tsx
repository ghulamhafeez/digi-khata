          ...
          <Dialog open={addOpen} onOpenChange={setAddOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Record Jama (diya) or Wapsi (liya).
                </DialogDescription>
              </DialogHeader>
              <AddTransactionForm
                customers={customers}
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-lg p-5 flex items-center gap-4">
              <div
                className={`w-12 h-12 rounded-xl flex items-center justify-center ${
                  netUdhaar > 0 ? "bg-orange-100" : "bg-blue-100"
                }`}
              >
                <Receipt
                  className={`h-6 w-6 ${
                    netUdhaar > 0 ? "text-orange-500" : "text-blue-500"
                  }`}
                />
              </div>
              <div>
        ...
        {loading ? (
          <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {[...Array(3)].map((_, i) => (
                <div
                  key={i}
                  className="bg-white rounded-2xl border border-gray-100 shadow-lg p-5 flex items-center gap-4 animate-pulse"
                >
          ...
          <div className="flex flex-col items-center justify-center py-32 gap-4 text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-800">
              Pehle customer add karein
            </h3>
            <p className="text-sm text-gray-500">
              Transaction ke liye customer hona zaruri hai.
            </p>
            <Link href="/customers">
                    ...
                    <div>
                      <span
                        className={`font-bold text-sm ${
                          tx.type === "jama" ? "text-red-600" : "text-green-600"
                        }`}
                      >
                        {tx.type === "jama" ? "+" : "−"} Rs.{" "}
                        {tx.amount.toLocaleString()}
